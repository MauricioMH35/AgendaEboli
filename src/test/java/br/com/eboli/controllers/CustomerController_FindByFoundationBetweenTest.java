...
public class CustomerController_FindByFoundationBetweenTest {
    ...
    @Test
    @DisplayName("When Find By Foundation Between And Retuns Ok")
    void whenFindByFoundationBetweenAndRetunsOk() throws Exception {
        mvc.perform(get("/v1/api/customers/find?foundation-start=1990.01.01&foundation-end=2000.01.01")
    ...
    void whenFindByFoundationBetweenAndReturnsNotFound() throws Exception {
        mvc.perform(get("/v1/api/customers/find?foundation-start=1800.01.01&foundation-end=1900.01.01")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
        ).andDo(print())
                ...
                .andExpect(jsonPath("$.message").value("Não foi possivel encontrar clientes entre as datas de fundação."));
    }
}
